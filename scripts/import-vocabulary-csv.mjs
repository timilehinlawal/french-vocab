...
const thirdVocabulary = compactVocabulary([
  ...
  ["analyser", "to analyse", "Expressions", "High", "analyser + situation / données"],
  ...
  ["actuel", "current", "Expressions", "High", "la situation actuelle"],
  ["rythme", "pace, rhythm", "Expressions", "High", "au rythme de + nom"],
  ["délirant", "delirious, absurd", "Adjective", "Medium", "un rythme délirant"],
  ["démarche", "approach, process", "Expressions", "High", "une démarche cohérente"],
  ["politique", "policy", "Society", "High", "une politique publique"],
  ["militer", "to campaign, advocate", "Society", "High", "militer pour + cause"],
  ["contourner", "to bypass", "Expressions", "High", "contourner + obstacle / règle"],
  ...
  ["devoir + infinitif", "to have to, must", "Expressions", "High", "devoir + infinitif"],
  ...
  ["décortiquer", "to break down, analyse in detail", "Expressions", "High", "décortiquer + problème / texte"],
  ...
  ["approfondir", "to deepen, explore further", "Expressions", "High", "approfondir + sujet"],
  ["contester", "to challenge, dispute", "Expressions", "High", "contester + décision"],
  ["inévitable", "inevitable", "Adjective", "High", "une conséquence inévitable"],
  ["effectuer", "to carry out, perform", "Expressions", "High", "effectuer + tâche"],
  ...
  ["domaine", "field, area", "Expressions", "High", "dans le domaine de + nom"],
  ["trajet", "journey, trip", "Travel", "Medium", "faire un trajet"],
  ["parcours", "route, journey, path", "Expressions", "High", "un parcours professionnel"],
  ["enjeu", "challenge, stake, issue", "Expressions", "High", "un enjeu majeur"],
  ...
  ["maintenir", "to maintain, keep", "Expressions", "High", "maintenir + niveau / effort"],
  ...
  ["valoriser", "to value", "Expressions", "High", "valoriser + compétence"],
  ["injuste", "unfair", "Adjective", "High", "une décision injuste"],
  ["chacun", "each, everyone", "Pronoun", "High", "chacun peut + infinitif"],
  ["déclencheur", "trigger", "Expressions", "High", "un élément déclencheur"],
  ...
  ["répandre", "to spread, disseminate", "Expressions", "High", "répandre + idée"],
  ...
  ["changement", "change", "Expressions", "High", "un changement majeur"],
  ["changer", "to change", "Verb", "High", "changer de + nom"],
  ["transcender", "to transcend", "Expressions", "Medium", "transcender + limite"],
  ["déléguer", "to delegate", "Work", "High", "déléguer + tâche"],
  ["réflexion", "reflection, thought", "Expressions", "High", "mener une réflexion"],
  ["esprit", "mind, spirit", "Expressions", "High", "avoir l'esprit ouvert"],
  ...
  ["sans critique", "without criticism", "Expressions", "Medium", "accepter sans critique"],
...
const fourthVocabulary = compactVocabulary([
  ...
  ["cesser", "to stop, cease", "Expressions", "High", "cesser de + infinitif"],
  ...
  ["expliquer", "to explain", "Expressions", "High", "expliquer + idée à + personne"],
  ...
  ["juger", "to judge", "Expressions", "High", "juger que + phrase"],
  ["gagner", "to win, earn", "Verb", "High", "gagner + argent / compétition"],
  ["sensibiliser", "to raise awareness", "Expressions", "High", "sensibiliser + public à + sujet"],
  ...
  ["manquer", "to miss, lack", "Expressions", "High", "manquer de + nom"],
  ["marcher", "to walk", "Everyday Vocabulary", "High", "marcher dans + lieu"],
  ["mériter", "to deserve", "Expressions", "High", "mériter + nom / de + infinitif"],
  ...
  ["penser", "to think", "Expressions", "High", "penser à / que + phrase"],
  ["porter", "to carry, wear", "Verb", "High", "porter + objet / vêtement"],
  ["présenter", "to present", "Expressions", "High", "présenter + idée / personne"],
  ...
  ["regretter", "to regret", "Expressions", "High", "regretter de + infinitif"],
  ...
  ["souhaiter", "to wish", "Expressions", "High", "souhaiter + infinitif / que + subjonctif"],
  ...
  ["bâtir", "to build", "Expressions", "High", "bâtir + projet / maison"],
  ...
  ["retenir", "to retain, remember", "Expressions", "High", "retenir + information"],
  ["entretenir", "to maintain", "Expressions", "High", "entretenir + relation / lieu"],
  ...
  ["réfléchir", "to reflect, think about", "Expressions", "High", "réfléchir à + sujet"],
  ["remplir", "to fill", "Everyday Vocabulary", "High", "remplir + formulaire"],
  ["réussir", "to succeed", "Expressions", "High", "réussir à + infinitif"],
  ["rougir", "to blush", "Emotion", "Medium", "rougir de + émotion"],
  ["saisir", "to seize, grasp", "Expressions", "High", "saisir + occasion / idée"],
  ...
  ["dépendre", "to depend", "Expressions", "High", "dépendre de + nom"],
  ...
  ["construire", "to build", "Expressions", "High", "construire + projet / bâtiment"],
  ["fondre", "to melt", "Verb", "Medium", "fondre avec + chaleur"],
  ["remettre", "to put back", "Expressions", "High", "remettre + objet / décision"],
  ["accroître", "to increase", "Expressions", "High", "accroître + nom abstrait"],
  ...
  ["permettre", "to allow", "Expressions", "High", "permettre à + personne de + infinitif"],
  ["apprendre", "to learn", "Education", "High", "apprendre à + infinitif"],
  ["suivre", "to follow", "Expressions", "High", "suivre + cours / règle"],
  ["tenter", "to attempt", "Expressions", "High", "tenter de + infinitif"],
  ["emmener", "to take a person", "Verb", "Medium", "emmener + personne à + lieu"],
  ["reculer", "to step back", "Verb", "Medium", "reculer devant + obstacle"],
  ["garder", "to keep", "Verb", "High", "garder + objet / idée"],
  ["marquer", "to mark, highlight", "Expressions", "High", "marquer + différence / point"],
  ["basculer", "to switch, shift", "Expressions", "High", "basculer vers + état"],
  ["dérouler", "to unfold, take place", "Expressions", "High", "se dérouler à + lieu"],
  ...
  ["diriger", "to direct", "Expressions", "High", "diriger + équipe / projet"],
  ...
  ["force", "strength", "Expressions", "High", "la force de + nom"],
  ["milieu", "environment, setting, middle", "Expressions", "High", "dans un milieu + adjectif"],
  ...
  ["exposer", "to expose", "Expressions", "High", "exposer + problème / personne à + risque"],
  ...
  ["empêcher", "to prevent", "Expressions", "High", "empêcher + personne de + infinitif"],
  ["partager", "to share", "Expressions", "High", "partager + idée / ressource"],
  ["protéger", "to protect", "Environment", "High", "protéger + personne / planète"],
  ["mentir", "to lie", "Everyday Vocabulary", "Medium", "mentir à + personne"],
  ["parcourir", "to travel through, cover", "Expressions", "High", "parcourir + lieu / texte"],
  ...
  ["remplacer", "to replace", "Expressions", "High", "remplacer + élément par + autre"],
...
rows.forEach((row, rowIndex) => {
  ...
  const priority = toPriority(row[columnIndex["Priority"]] ?? "");
...
extraVocabulary.forEach((word) => {
  addVocabularyItem({
    ...
    repairPrompt: `Use « ${word.french} » in one natural sentence, then say it again with ${word.synonymLadder?.[0] ?? "a synonym"}.`
  });
});
...
const manualSourceOne = "Vocabulary batch";
const manualSourceTwo = "Vocabulary batch 2";
const manualSourceThree = "Vocabulary batch 3";
const manualSourceFour = "Vocabulary batch 4";
